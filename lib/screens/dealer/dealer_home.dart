...
import 'package:intelli_farm/screens/common/dealer_farmer_chat.dart'; // Import your chat screen
...
class _DealerHomeState extends State<DealerHome> with TickerProviderStateMixin {
  ...
  void didChangeDependencies() {
    ...
    // Get the dealer ID passed via Navigator
    final args = ModalRoute.of(context)?.settings.arguments as Map<String, dynamic>?;
    dealerId = args?['dealerId'] ?? 'Unknown Dealer';
  }
              ...
              Wrap(
                ...
                children: [
                    ...
                    onTap: () {
                      if (dealerId != null) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => DealerFarmerChat(dealerId: dealerId!),
                          ),
                        );
                      }
                    },
                  ...
                  ActionIcon(
                    ...
                    onTap: () => Navigator.pushNamed(context, '/dealerOrders'),
                  ),
                  ActionIcon(
                    title: "My\nProfile",
                    icon: Icons.person,
                    onTap: () => Navigator.pushNamed(context, '/dealerProfile'),
                  ),
                  ActionIcon(
                    title: "Request\nTransport",
